...
class Post extends Model
{
    ...
    {
        $this->published = $this->published?$this->published:false;
    ...
    {
        $user = BackendAuth::getUser();
        return $this->exists ? $this->attributes['user_id'] : $user->id;
    }
    ...
    {
        return $query->whereRaw("MATCH(title,excerpt,content) AGAINST(? IN BOOLEAN MODE)", array($keyword));
    }
